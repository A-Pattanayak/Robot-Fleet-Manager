    ...
    <section className="mb-3 rounded-lg border border-zinc-800 bg-zinc-900 px-4 py-3 shadow-sm">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          type="button"
          onClick={onAddRobot}
          className="w-full rounded-lg bg-orange-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors duration-150 hover:bg-orange-700 sm:w-auto"
        >
          Add Robot
        </button>
      </div>
